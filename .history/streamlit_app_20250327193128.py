...
def create_attention_graph(
    ...
    for pattern in filtered_patterns:
        # Get color based on head's group or individual head
        color = None
        for head in selected_heads:
            if head.layer == pattern['sourceLayer'] and head.head == pattern['head']:
        ...
        # Determine legend name based on whether it's a group or individual head
        legend_name = None
        for head in selected_heads:
            if head.layer == pattern['sourceLayer'] and head.head == pattern['head']:
