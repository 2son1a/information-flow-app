...
from components.d3_attention_graph.d3_attention_graph import d3_attention_graph
...
def create_attention_graph(
    ...
    """Create graph visualization using D3."""
    ...
    d3_attention_graph(
        ...
        width=1000,
        height=700,
        key=f"attention_graph_{st.session_state.current_model}"
    )
