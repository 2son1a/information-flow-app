...
def main():
    ...
    st.markdown("""
        ...
        /* Style for the color picker and remove buttons */
        div[data-testid="stHorizontalBlock"] > div:last-child button[data-testid="baseButton-primary"],
        div[data-testid="stHorizontalBlock"] > div:last-child button[data-testid="baseButton-secondary"] {
        ...
        div[data-testid="stHorizontalBlock"] > div:last-child button[data-testid="baseButton-secondary"]:hover {
            color: #000 !important;
            background: transparent !important;
        }
        ...
        with col1:
            ...
            for group in st.session_state.head_groups:
                ...
                with group_container:
                    ...
                    group_col1, group_col2 = st.columns([6, 0.6])
                    ...
                    with group_col2:
                        st.write('<div style="display: flex; gap: 0px; justify-content: flex-end;">', unsafe_allow_html=True)
