    ...
    for pattern in filtered_patterns:
        ...
        for group in head_groups:
            if any(h.layer == pattern['sourceLayer'] and h.head == pattern['head'] for h in group.heads):
                ...
                if 'Subject' in group.name:
                    color = head_type_colors['Subject']
                elif 'Relation' in group.name:
                    color = head_type_colors['Relation']
                elif 'Mixed' in group.name:
                    color = head_type_colors['Mixed']
                break
        ...
        fig.add_trace(go.Scatter(
            ...
            line=dict(
                color=color,
                width=2 * pattern['weight']  # Line width based on attention weight
            ),
