        ...
        with col1:
            ...
            for group in st.session_state.head_groups:
                with st.container():
                    st.markdown(f"""
                        <div class="group-container">
                            <div style="display: flex; align-items: center; justify-content: space-between; gap: 8px;">
                                ...
                                <div>
                                    <button class="stButton" style="padding: 0.25rem 0.5rem; font-size: 0.8rem; border-radius: 4px; border: none; background: transparent; cursor: pointer;" onclick="document.getElementById('color_{group.id}').click()">🎨</button>
                                </div>
                            </div>
                    ...
                    if st.button("🎨", key=f"color_{group.id}", help="Change group color", style="display: none;"):
