...
class D3AttentionGraph extends StreamlitComponentBase<State, ComponentArgs> {
  private svgRef: React.RefObject<SVGSVGElement | null>;

  constructor(props: { args: ComponentArgs; width: number; disabled: boolean }) {
    super(props);
  ...
  componentDidMount() {
    // Get the component's dimensions from Streamlit
    const { width, height } = this.props.args;
