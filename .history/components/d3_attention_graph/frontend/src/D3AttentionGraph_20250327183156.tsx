...
// Streamlit wrapper component
class StreamlitD3AttentionGraph extends StreamlitComponentBase<State, ComponentArgs> {
  render() {
    const { data, width, height } = this.props.args;
    return <D3AttentionGraph data={data} width={width} height={height} />;
  }
}

// Export the base component for direct React usage
export { D3AttentionGraph };
// Export the Streamlit-wrapped component as default for Streamlit usage
export default withStreamlitConnection(StreamlitD3AttentionGraph); 